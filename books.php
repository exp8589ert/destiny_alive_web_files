...
-->
	...
	<header role="banner" id="books_page_header">
		<div class="books_header_cont">
...
<div class="destiny_alive_inner_cont">
	...
	<section class="destiny_alive_Section">
		<div class="menu">
			<nav role="navigation">
				<ul>
					<li><a href="http://destinyalive.com/sections/destiny_alive/"><i class="fa fa-check-square-o" aria-hidden="true"></i>&nbsp;Destiny Alive</a></li>
					<li><a href="http://destinyalive.com/sections/the_gospel/">The Gospel</a></li>
					<li><a href="#">Baptism</a></li>
					<li><a href="#">Church Network</a></li>
					<li class="selected"><a href="#">Christian Books &nbsp;<i class="fa fa-file-pdf-o" aria-hidden="true"></i></a></li>
					<li><a href="#"></a></li>
				</ul>
			</nav>
		</div>
